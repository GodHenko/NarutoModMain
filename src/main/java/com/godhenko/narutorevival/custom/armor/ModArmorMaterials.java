package com.godhenko.narutorevival.custom.armor;
...
public enum ModArmorMaterials implements ArmorMaterial {
    GENIN("genin", 13, new int[]{2, 3, 5, 3}, 21,
            SoundEvents.ARMOR_EQUIP_GOLD, 0.5F, 0.0F, () -> {
        return Ingredient.of(ItemInit.NINJA_FABRIC.get());
    });
    ...
    public String getName() {
        return NarutoRevival.MOD_ID + ":" + this.name;
    }
