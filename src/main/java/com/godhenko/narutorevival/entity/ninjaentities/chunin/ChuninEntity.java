...
public class ChuninEntity extends Animal {
    public ChuninEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.FOLLOW_RANGE, 35.0D).add(Attributes.MOVEMENT_SPEED, (double)0.23F).add(Attributes.ATTACK_DAMAGE, 4.5D).add(Attributes.ARMOR, 3.5D).add(Attributes.SPAWN_REINFORCEMENTS_CHANCE);
    }
}
