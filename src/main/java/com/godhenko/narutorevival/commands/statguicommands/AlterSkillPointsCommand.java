...
import com.godhenko.narutorevival.procedures.guiprocedures.addxpprocedures.SkillPointsSettingProcedure;
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("setsp")
				...
				.then(Commands.argument("value", DoubleArgumentType.doubleArg()).executes(arguments -> {
					...
					SkillPointsSettingProcedure.execute(arguments, entity);
					return 0;
				})));
	}
}
