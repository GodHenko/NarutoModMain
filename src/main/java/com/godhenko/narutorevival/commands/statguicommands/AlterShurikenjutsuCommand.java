...
import com.godhenko.narutorevival.procedures.guiprocedures.addxpprocedures.ShurikenjutsuSettingProcedure;
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("setshurikenjutsu")
				...
				.then(Commands.argument("value", DoubleArgumentType.doubleArg()).executes(arguments -> {
					...
					ShurikenjutsuSettingProcedure.execute(arguments, entity);
					return 0;
				})));
	}
}
