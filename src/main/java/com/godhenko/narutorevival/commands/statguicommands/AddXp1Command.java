...
public class AddXp1Command {
	@SubscribeEvent
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("addxp1")

				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(AddXp1Command::execute))
				.executes(AddXp1Command::execute));
	}
	...
	private static int execute(CommandContext<CommandSourceStack> ctx) {
		...
		AddXp1CommandExecutedProcedure.execute(world);
		return 0;
	}
}
