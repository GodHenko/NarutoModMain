...
public class FireballProjectile extends JutsuProjectile {
    public FireballProjectile(EntityType<FireballProjectile> entityType, Level world) {
        super(entityType, world);
    }

    public FireballProjectile(double x, double y, double z, double xPower, double yPower, double zPower, Level world) {
        super((EntityType<? extends JutsuProjectile>) ModRegistry.FIREBALL_PROJECTILE.get(), x, y, z, xPower, yPower, zPower, world);
    }

    public FireballProjectile(LivingEntity owner, double xPower, double yPower, double zPower, Level world) {
    ...
    public FireballProjectile(LivingEntity owner, double power, Level world) {
