...
import com.godhenko.narutorevival.inits.MenusInit;
...
public class BackpackMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BackpackMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(27, this.addSlot(new SlotItemHandler(internal, 27, 7, 74) {
		}));
		this.customSlots.put(28, this.addSlot(new SlotItemHandler(internal, 28, 25, 74) {
		}));
		this.customSlots.put(29, this.addSlot(new SlotItemHandler(internal, 29, 43, 74) {
		}));
		this.customSlots.put(30, this.addSlot(new SlotItemHandler(internal, 30, 61, 74) {
		}));
		this.customSlots.put(31, this.addSlot(new SlotItemHandler(internal, 31, 79, 74) {
		}));
