...
public class NarutoRevivalModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		NarutoMod.addNetworkMessage(SavedDataSyncMessage.class, SavedDataSyncMessage::buffer, SavedDataSyncMessage::new,
	...
	public static class EventBusVariableHandlers {
		...
		public static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
			if (!event.getPlayer().level.isClientSide()) {
				...
				if (mapdata != null)
					NarutoMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayer) event.getPlayer()),
	...
	public static class WorldVariables extends SavedData {
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level level && !level.isClientSide())
				NarutoMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(level::dimension), new SavedDataSyncMessage(1, this));
		}
	...
	public static class MapVariables extends SavedData {
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level && !world.isClientSide())
				NarutoMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new SavedDataSyncMessage(0, this));
		}
