...
import com.godhenko.narutomod.procedures.guiprocedures.OpenStatsMenuOnKeyPressedProcedure;
...
public class OpenStatsMenuMessage {
    ...
    public static void registerMessage(FMLCommonSetupEvent event) {
        NarutoMod.addNetworkMessage(OpenStatsMenuMessage.class, OpenStatsMenuMessage::buffer, OpenStatsMenuMessage::new,
