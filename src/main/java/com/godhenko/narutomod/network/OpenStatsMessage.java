...
import com.godhenko.narutomod.procedures.guiprocedures.otherprocedures.OpenStatsOnKeyPressedProcedure;
...
public class OpenStatsMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		NarutoMod.addNetworkMessage(OpenStatsMessage.class, OpenStatsMessage::buffer, OpenStatsMessage::new, OpenStatsMessage::handler);
	}
}
